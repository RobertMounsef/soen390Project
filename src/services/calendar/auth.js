...
/**
 * Optional: Web application OAuth clients require client_secret for token exchange.
 * For this course project we read it from EXPO_PUBLIC_GOOGLE_OAUTH_CLIENT_SECRET so the
 * mobile app can talk directly to Google's token endpoint. In a real production app,
 * you should move the code→token exchange to a backend instead of bundling the secret.
 */
