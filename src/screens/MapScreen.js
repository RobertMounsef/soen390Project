...
const styles = StyleSheet.create({
  ...
  tabText: { fontSize: 16, fontWeight: '600', color: '#2d3748' },
  ...
  locationText: { fontSize: 15, fontWeight: '600', color: '#1a202c' },
  ...
  directionsTitle: { flex: 1, fontSize: 14, fontWeight: '700', color: '#2d3748' },
  closeDirections: { fontSize: 18, fontWeight: '700', color: '#6b7280', marginLeft: 12 },
  clearRouteText: { fontSize: 13, fontWeight: '700', color: '#6b7280', marginRight: 8 },
  ...
  goArrow: { fontSize: 18, color: '#8B1538', marginLeft: 8, fontWeight: '700' },
