...
const RAW_POINTS = [
  ...
  { type: 'Feature', properties: { id: 'EN', name: 'EN Annex', campus: 'SGW', code: 'EN' }, geometry: { type: 'Point', coordinates: [-73.5797, 45.4968] } },
  { type: 'Feature', properties: { id: 'ER', name: 'ER Building', campus: 'SGW', code: 'ER' }, geometry: { type: 'Point', coordinates: [-73.57999, 45.496428] } },
  ...
  { type: 'Feature', properties: { id: 'FA', name: 'FA Annex', campus: 'SGW', code: 'FA' }, geometry: { type: 'Point', coordinates: [-73.5795, 45.49685] } }, //
  ...
  { type: 'Feature', properties: { id: 'FG', name: 'Faubourg Ste-Catherine Building', campus: 'SGW', code: 'FG' }, geometry: { type: 'Point', coordinates: [-73.5784, 45.49430] } },
  { type: 'Feature', properties: { id: 'GA', name: 'Grey Nuns Annex', campus: 'SGW', code: 'GA' }, geometry: { type: 'Point', coordinates: [-73.57787, 45.49419] } },
  ...
  { type: 'Feature', properties: { id: 'GN', name: 'Grey Nuns Building', campus: 'SGW', code: 'GN' }, geometry: { type: 'Point', coordinates: [-73.577003, 45.493622] } },
  { type: 'Feature', properties: { id: 'GS', name: 'Guy-Sherbrooke Building', campus: 'SGW', code: 'GS' }, geometry: { type: 'Point', coordinates: [-73.58138, 45.49663] } },
  { type: 'Feature', properties: { id: 'H', name: 'Henry F. Hall Building', campus: 'SGW', code: 'H' }, geometry: { type: 'Point', coordinates: [-73.5788, 45.497092] } },
  { type: 'Feature', properties: { id: 'HA', name: 'Hingston Hall, wing HA', campus: 'LOY', code: 'HA' }, geometry: { type: 'Point', coordinates: [-73.64127, 45.459356] } },
  ...
  { type: 'Feature', properties: { id: 'HC', name: 'Hingston Hall, wing HC', campus: 'LOY', code: 'HC' }, geometry: { type: 'Point', coordinates: [-73.64208, 45.459663] } },
  ...
  { type: 'Feature', properties: { id: 'LB', name: 'J.W. McConnell Building', campus: 'SGW', code: 'LB' }, geometry: { type: 'Point', coordinates: [-73.578009, 45.49705] } },
  ...
  { type: 'Feature', properties: { id: 'MU', name: 'MU Annex', campus: 'SGW', code: 'MU' }, geometry: { type: 'Point', coordinates: [-73.57955, 45.49792] } },
  { type: 'Feature', properties: { id: 'P', name: 'P Annex', campus: 'SGW', code: 'P' }, geometry: { type: 'Point', coordinates: [-73.57912, 45.49667] } },
  { type: 'Feature', properties: { id: 'PC', name: 'PERFORM centre', campus: 'LOY', code: 'PC' }, geometry: { type: 'Point', coordinates: [-73.637683, 45.457088] } },
  { type: 'Feature', properties: { id: 'PR', name: 'PR Annex', campus: 'SGW', code: 'PR' }, geometry: { type: 'Point', coordinates: [-73.57980, 45.49699] } },
  ...
  { type: 'Feature', properties: { id: 'Q', name: 'Q Annex', campus: 'SGW', code: 'Q' }, geometry: { type: 'Point', coordinates: [-73.57913, 45.4966] } },
  { type: 'Feature', properties: { id: 'R', name: 'R Annex', campus: 'SGW', code: 'R' }, geometry: { type: 'Point', coordinates: [-73.579389, 45.496812] } },
  { type: 'Feature', properties: { id: 'RA', name: 'Recreation and Athletics Complex', campus: 'LOY', code: 'RA' }, geometry: { type: 'Point', coordinates: [-73.63761, 45.456774] } },
  ...
  { type: 'Feature', properties: { id: 'RR', name: 'RR Annex', campus: 'SGW', code: 'RR' }, geometry: { type: 'Point', coordinates: [-73.57942, 45.49669] } }, //
  { type: 'Feature', properties: { id: 'S', name: 'S Annex', campus: 'SGW', code: 'S' }, geometry: { type: 'Point', coordinates: [-73.579851, 45.497423] } },
  { type: 'Feature', properties: { id: 'SB', name: 'Samuel Bronfman Building', campus: 'SGW', code: 'SB' }, geometry: { type: 'Point', coordinates: [-73.58609, 45.4966] } },
  ...
  { type: 'Feature', properties: { id: 'T', name: 'T Annex', campus: 'SGW', code: 'T' }, geometry: { type: 'Point', coordinates: [-73.57927, 45.49671] } },
