...
const RAW_POINTS = [
  ...
  { type: 'Feature', properties: { id: 'FG', name: 'Faubourg Ste-Catherine Building', campus: 'SGW', code: 'FG' }, geometry: { type: 'Point', coordinates: [-73.5784, 45.4943] } },
  ...
  { type: 'Feature', properties: { id: 'PR', name: 'PR Annex', campus: 'SGW', code: 'PR' }, geometry: { type: 'Point', coordinates: [-73.5798, 45.49699] } },
