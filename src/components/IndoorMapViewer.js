...
// Import SVG strings generated by script
import { SVG_STRINGS } from '../floor_plans/svgStrings';
...
export default function IndoorMapViewer({ visible, onClose, initialBuildingId }) {
  ...
  const currentSvgString = useMemo(() => {
    if (!currentGraph || !currentGraph.svgFile) return null;
    const key = currentGraph.svgFile.replace('.svg', '');
    return SVG_STRINGS[key] || null;
  }, [currentGraph]);
        ...
        <SafeAreaView style={styles.safeArea}>
          <View style={styles.container}>
            ...
            <View style={styles.mapAreaWrapper}>
              {currentSvgString ? (
                // ScrollView enables panning of the map if it's larger than the container
                <ScrollView 
                  horizontal 
                ...
                >
                  ...
                  >
                    <View 
                      style={[
                        styles.mapContainer, 
                        { aspectRatio: mapAspectRatio, width: SCREEN_WIDTH * 1.5 } // Multiply by 1.5 to make it zoomable/scrollable natively
                      ]}
                    >
                      <SvgXml xml={currentSvgString} width="100%" height="100%" />
                      ...
                      {selectedRoomData && (
                        ...
                        >
                          ...
                          <View style={styles.markerTooltip}>
                            <Text style={styles.markerTooltipText}>{selectedRoomData.label}</Text>
                          </View>
                        </View>
                      )}
                    </View>
...
const styles = StyleSheet.create({
  ...
  mapScrollH: {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    padding: 40, // More padding to center the map nicely
  },
  mapScrollV: {
    flexGrow: 1,
    justifyContent: 'center',
